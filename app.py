...
# --- SEKTION 2: DEPOT-MANAGER (DEIN ORIGINAL-STIL, FIXIERT) ---
st.markdown("---")
...
# Wir behalten deinen Ablauf exakt bei
depot_list = []
...
if depot_list:
    # DER TRICK: st.table statt st.dataframe
    # Das rendert die Liste in voller Länge auf der Seite ohne Scrollbalken.
