...
if test_modus:
    ticker_liste = ["NVDA", "TSLA", "PLTR", "AMD", "SMCI", "ARM", "MARA", "COIN", "MSTR", "AI",
    "SNOW", "U", "PATH", "AFRM", "RIVN", "SHOP", "SQ", "PYPL", "NET", "CRWD", "AAPL", "MSFT", "GOOGL", "AMZN", "META", "AVGO", "VRTX", "COST", "NFLX", "ADBE",
    "LIN", "V", "MA", "UNH", "JPM", "GS", "CAT", "DE", "LRCX", "ASML"]
else:
    ...
    if not filtered_tickers:
        ...
        def check_single_stock_optimized(symbol):
            try:
                ...
                if ask > (bid * 4): return None
                fair_price = (bid * 0.7) + (ask * 0.3) # Wir rechnen näher am Bid, um realistisch zu bleiben
