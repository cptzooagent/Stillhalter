...
def get_stock_basics(symbol):
    """Holt Preis, Optionen und RSI ohne komplexe Objekte zu cachen."""
    try:
        tk = yf.Ticker(symbol)
        price = tk.fast_info['last_price']
        dates = list(tk.options)
        # RSI Berechnung für Trend-Check
...
if t_input:
    ...
    if price and dates:
        ...
        try:
            ...
            # STRIKE-FILTER LOGIK FÜR SINNVOLLE ANZEIGE
            if opt_type == "put":
